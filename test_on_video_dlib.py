...
class ConvAutoencoder(nn.Module):
    ...
    def forward(self, x):
        ...
        t1=F.relu(self.t_conv3(encoder_output) + p3)
        x=F.relu(self.t_conv4(t1) + p2)
...
if __name__ == '__main__':
    ...
    # ResNet50 structure
    conv_autoencoder = ConvAutoencoder(torchvision.models.resnet.Bottleneck, [3, 4, 6, 3]).cuda(0)
    model = Hopenet(torchvision.models.resnet.Bottleneck, [3, 4, 6, 3], 67).cuda(0)
